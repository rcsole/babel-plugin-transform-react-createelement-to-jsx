/** Visitor factory for babel, converting Preact.h(...) to <jsx ...>...</jsx>
  *
...
export default function({types: t}) {
	...
	const isPreactCreateElement = node =>
		t.isCallExpression(node) &&
		t.isMemberExpression(node.callee) &&
		t.isIdentifier(node.callee.object,   { name: 'Preact' }) &&
		t.isIdentifier(node.callee.property, { name: 'h'      }) &&
